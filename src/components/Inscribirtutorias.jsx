...
const Inscribirtutorias = () => {
  ...
  const handleAgregarTutoria = () => {
    if (formData.tutoriasSeleccionadas.length < 3) {
      ...
      alert("No puedes agregar más tutorías, ya has seleccionado 3.");
    }
  };
      ...
      <Box bgcolor="white" p={3} borderRadius={4} display="flex" flexDirection="column" alignItems="center">
        ...
        {asignaturaSeleccionada && (
          <Box mt={2}>
            ...
            <Typography>{`Hora: ${asignaturaSeleccionada.hora}`}</Typography>
          </Box>
        )}
...
export default Inscribirtutorias;
